...
// CriarPublicacao adiciona um nova publicação no banco de dados
...
// BuscarPubliccoes traz publicações que apareceriam no feed do usuário
...
// BuscarPublicaco traz uma única publicação
...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.ID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possível aturalizar uma publicação que não seja sua"))
		return
	}
